...
for(var i=0 ; i < productList.length ; i++){
  //selection
  var clothingCards = document.getElementById("clothing-card");
  var accessoriesCards = document.getElementById("accessories-card");
  ...
  newImg.src =productList[i].preview;
  ...
  cost.innerText = productList[i].price;
